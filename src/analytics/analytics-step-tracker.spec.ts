...
import { isGoogleAnalyticsAvailable, isPayloadSizeLimitReached, sendGoogleAnalytics } from './analytics-tracker-window';

jest.mock('./analytics-tracker-window', () => ({
    ...
    describe('#trackOrderComplete()', () => {
        ...
        describe('When order does not reach Google Analytics payload limit', () => {
            beforeEach(() => {
                ...
                (sendGoogleAnalytics as jest.Mock<any>).mockImplementation(() => false);
